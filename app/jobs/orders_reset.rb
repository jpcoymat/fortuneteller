class OrdersReset
  ...
  def self.setup_data
    [ {"product" => Product.where(name: "SKUA001").first, "location" => Location.where(name: "Warehouse 1").first, "target_quantity" => -90, "days_to_target"=> 20,"lead_time"=> 7, "forecast_switch" => 30},
      {"product" => Product.where(name: "SKUA001").first, "location" => Location.where(name: "Warehouse 2").first, "target_quantity" => 60, "days_to_target" => 25, "lead_time"=> 7, "forecast_switch" => 30},
      ...
      {"product" => Product.where(name: "SKUA001").first, "location" => Location.where(name: "Warehouse 4").first,"target_quantity" => 590, "days_to_target" => 600, "lead_time"=> 7, "forecast_switch" => 30},
      ...
      {"product" => Product.where(name: "SKUB001").first, "location" => Location.where(name: "Warehouse 3").first, "target_quantity" => 510, "days_to_target"=> 600, "lead_time"=> 7, "forecast_switch" => 30},
